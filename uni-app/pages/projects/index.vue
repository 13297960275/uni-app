		...
		<view class="cover-container" :style="[{
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="history-section icon">
				...
				<list-cell navigateType="arrowright" iconColor="#e07472" title="我的钱包:" tips="您的会员还有3天过期"><text slot="tipsRight">过期</text></list-cell>
				<list-cell icon="camera-filled" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/address/address')"> <button slot="tipsRight" class="mini-btn" type="primary" size="mini">按钮</button></list-cell>
				<list-cell icon="camera-filled" iconColor="#9789f7" title="分享" tips="邀请好友赢10万大礼"></list-cell>
				<list-cell icon="camera-filled" iconColor="#ee883b" title="晒单" tips="晒单抢红包"></list-cell>
				<list-cell icon="camera-filled" iconColor="#54b4ef" title="我的收藏"></list-cell>
				<list-cell icon="camera-filled" iconColor="#e07472" title="设置" @eventClick="navTo('/pages/set/set')"></list-cell>
			</view>
		</view>
...
<script>
	import listCell from './components/item-title';
	import {
		mapState
	} from 'vuex';
	let startY = 0,
