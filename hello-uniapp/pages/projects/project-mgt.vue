      ...
      <view class="uni-common-mt">
        <view class="uni-card-border">
          <form @submit="formSubmit" @reset="formReset">
            <button
              class="mini-btn"
              :style="{ borderColor: '#47c4df' }"
              plain="true"
              size="mini"
              form-type="submit"
            >
              <uni-icons :type="'gear-filled'" :color="'#47c4df'" size="13" />
              <text style="margin-left: 0.125rem" :style="{ color: '#47c4df' }"
                >修改</text
              >
            </button>
            <button
              class="mini-btn"
              :style="{ borderColor: '#21caad' }"
              plain="true"
              size="mini"
              form-type="reset"
            >
              <uni-icons :type="'gear-filled'" :color="'#21caad'" size="13" />
              <text style="margin-left: 0.125rem" :style="{ color: '#21caad' }"
                >保存</text
              >
            </button>
            ...
            <view class="uni-form-item uni-row">
              ...
              <view class="content">
                <picker
                  ...
                  @change="bindPickerChange($event, 'beginDate')"
                >
            ...
            <view class="uni-form-item uni-row">
              ...
              <view class="content">
                <picker
                  mode="date"
                  :value="form.endDate"
                  @change="bindPickerChange($event, 'endDate')"
                >
            ...
            <view class="uni-form-item uni-row">
              ...
              <view class="content">
                <view class="picker-content">
                  <picker
                    @change="bindPickerChange($event, 'swIndex')"
                    :value="form.swIndex"
                    :range="array"
                    range-key="name"
                  >
                    <view class="uni-input picker-content">{{
                      array[form.swIndex].name
                    }}</view>
                  </picker>
                </view>
            ...
            <view class="uni-form-item uni-row">
              ...
              <view class="content">
                <view class="picker-content">
                  <picker
                    @change="bindPickerChange($event, 'khIndex')"
                    :value="form.khIndex"
                    :range="array"
                    range-key="name"
                  >
                    <view class="uni-input picker-content">{{
                      array[form.khIndex].name
                    }}</view>
                  </picker>
                </view>
                <view class="number-content">
      ...
      <view class="uni-card-border" v-for="(el, idx) in groupList" :key="idx">
        ...
        >
          <view class="flex-center" slot="tipsRight">
            <button
              class="mini-btn"
              :disabled="el.workStatus != '入场'"
              :style="{ borderColor: '#47c4df', padding: '0 0.5rem' }"
              plain="true"
              size="mini"
            >
              <uni-icons :type="'gear-filled'" :color="'#47c4df'" size="13" />
            ...
            <button
              class="mini-btn"
              :disabled="el.workStatus != '离场'"
              :style="{ borderColor: '#ff7272', padding: '0 0.5rem' }"
              plain="true"
              size="mini"
            >
              <uni-icons :type="'gear-filled'" :color="'#ff7272'" size="13" />
              <text style="margin-left: 0.125rem" :style="{ color: '#ff7272' }"
                >离场</text
              >
            </button>
          </view>
