  ...
  data () {
    return {
      ...
      indexPage: [
        ...
        {
          tabBar: '/pages/tabBar/application/application',
          index: '/pages/application/ocrApi/ocrApi'
        },
        {
          tabBar: '/pages/tabBar/uniCloud/uniCloud',
          index: '/pages/uniCloud/cloudFunction/cloudFunction'
        }
      ]
    }
  },
