    ...
    >
      ...
      >
        ...
        >
          <span
            slot="right"
            style="color: #007aff; cursor: pointer; padding-right: 10px"
            @click="showIconPopup"
            >内置图标</span
          >
        </uni-easyinput>
      ...
      <view class="uni-button-group">
        ...
        <navigator open-type="navigateBack" style="margin-left: 15px"
          ><button class="uni-button" tyle="width: 100px;">
            返回
          </button></navigator
        >
      </view>
